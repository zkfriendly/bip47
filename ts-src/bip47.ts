...
export class BIP47 implements BIP47Interface {
  ...
  getPaymentCodeFromRawNotificationTransaction(rawHexNotificationData: string) {
    ...
    if (!opReturnOutput) throw Error('No OP_RETURN output in notification');
